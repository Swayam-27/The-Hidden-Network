  ...
  "project-raven": {
    ...
    overview: (
      <>
        ...
        <p>
          Operating under the cover of a legitimate American cybersecurity firm, <strong>CyberPoint International</strong>, the
  ...
  "cambridge-analytica": {
    ...
    timeline: (
      <ul>
        ...
        <li><strong>2018 March:</strong> Guardian/Observer/NYT publish explosive exposé; Channel 4 airs undercover videos of <strong>Alexander Nix</strong> boasting about dirty tricks; Facebook stock crashes.</li>
    ...
    firstPuzzle: {
      type: "social-graph",
      prompt: "The 'Case Overview' identifies the academic who created the data-harvesting app. Identify his node in the social graph to begin the investigation.",
      nodes: [
    ...
    episodes: [
      ...
      },
      {
        ...
        puzzle: {
            ...
            prompt: "The 'Key Events Timeline' identifies the executive exposed in undercover videos. De-redact the transcript to reveal his name.",
